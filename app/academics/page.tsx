...
export default function Academics() {
  const earlyYearsPrograms = [
    ...
    },
    {
      ...
      description: "Pre-literacy and pre-numeracy skills, creative arts and crafts, basic Islamic studies, physical development activities.",
      icon: Palette,
  ...
  const primarySubjects = [
    ...
    { name: "Islamic Religious Studies", icon: Heart },
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Islamic values and teachings are seamlessly integrated into all aspects of learning, creating morally conscious students.",
                icon: "☪️",
              },
              {
